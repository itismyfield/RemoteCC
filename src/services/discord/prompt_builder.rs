...
pub(super) fn build_system_prompt(
    ...
    let mut system_prompt_owned = format!(
        "You are chatting with a user through Discord.\n\
         ...
         Discord formatting rules (apply ONLY to Discord message output — when writing .md or other files, use standard markdown including tables):\n\
         - Do NOT use markdown tables in Discord messages — Discord cannot render them. Use simple lists or key: value pairs instead.\n\
         ...
         - When writing .md files, use standard markdown formatting including tables.\n\n\
